...
namespace CybersecurityChatbotPartTwo
{
    ...
    {
        // Dictionary for keyword -> list of responses (Requirement 8 - using Dictionary)
        ...
        {
            // ========================================
            // PASSWORD RESPONSES (multiple for random selection)
            // ========================================
            ...
            keywordResponses.Add("scam", new List<string> {
                "⚠️ SCAM ALERT: Scammers often pretend to be from banks, the government, or tech support. Hang up and call the official number.",
                "⚠️ SCAM ALERT: Never send money to someone you've only met online - romance scams are very common in South Africa.",
                "⚠️ SCAM ALERT: If something seems too good to be true (lottery winnings, huge discounts), it probably is a scam."
            });
            ...
            keywordResponses.Add("privacy", new List<string> {
                "🛡️ PRIVACY TIP: Review your privacy settings on social media regularly. Limit what the public can see.",
                "🛡️ PRIVACY TIP: Be careful about what personal information you share online - your address, phone number, and ID number are valuable to criminals.",
                "🛡️ PRIVACY TIP: South Africa's POPIA (Protection of Personal Information Act) gives you rights over your personal data."
            });
        ...
        // Match user input to a keyword (Requirement 2)
        ...
        // Get random response for a keyword (Requirement 3)
        ...
        // Get display name for memory (Requirement 5)
